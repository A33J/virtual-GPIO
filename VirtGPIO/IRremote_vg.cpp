// This is a modified version of IRremote, specifically for Virtual GPIO
// The assignment of pin is not done at object creation (compilation time),
// but can be done later at runtime.
// Brian Lavery  Oct 2014    http://virtgpio.blavery.com

// Origin of THIS copy:   https://github.com/shirriff/Arduino-IRremote
...
void IRrecv::enableIRIn(int recvpin)    // THIS (overloaded) CALL ADDED FOR VIRTUAL-GPIO
{
  irparams.recvpin = recvpin;
  enableIRIn();
}
